...
import { DeleteBlackIcon, EditBlackIcon, LockIcon, PlusIcon, RightIcon } from "@/public/Assets/Icons/Allsvg";
      ...
      <div>
        ...
        <div className="flex xl:gap-[45px] sm:gap-[30px] gap-[10px] flex-wrap ">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4">
                <button onClick={() => handleDatasetEdit()}>
                  <EditBlackIcon />
                </button>
                              ...
                              <div className="relative w-full  mx-auto max-w-[470px]">
                                <div className="rounded-lg  relative flex flex-col w-full bg-white outline-none focus:outline-none  sm:px-[41px] px-[15px]">
                                  ...
                                  <p className="text-left text-[14px] font-medium font-Inter text-[#68727D] ">
                                    The project you are trying to delete has 20
                                    traces in it. Do you want to delete them or
          ...
          {isModalOpen && (
            ...
            >
              <AddDatasetModal updateProjectList={getDatasetList} dataset_status={createDatasetStatus} />
            </div>
          )}
        </div>
      </div>
